...
export default async function EventDetailsPage({
    ...
    // Extract Source URL from description if present (until schema migration adds ticket_url)
    ...
    return (
        <div className="min-h-screen bg-brand-cream">
            ...
            <div className="container mx-auto grid gap-12 px-4 pb-20 md:grid-cols-3">
                {/* Main Content - Centered for News, Left for Events */}
                ...
                {/* Sidebar Sticky - ONLY SHOW FOR EVENTS */}
                {!isNews && (
